module crcc_loops
      ...
      contains
              ...
              subroutine crcc23A(deltaA,deltaB,deltaC,deltaD,&
                        ...
                        real, intent(in) :: MM23A(1:nua,1:nua,1:nua,1:noa,1:noa,1:noa),&
              ...
              subroutine crcc23B(deltaA,deltaB,deltaC,deltaD,&
                        ...
                        real, intent(in) :: MM23B(1:nua,1:nua,1:nub,1:noa,1:noa,1:nob),&
              ...
              subroutine crcc23C(deltaA,deltaB,deltaC,deltaD,&
                        ...
                        real, intent(out) :: deltaA, deltaB, deltaC, deltaD
                        integer, intent(in) :: noa, nua, nob, nub
                        real, intent(in) :: MM23C(1:nua,1:nub,1:nub,1:noa,1:nob,1:nob),&
              ...
              subroutine crcc23D(deltaA,deltaB,deltaC,deltaD,&
                        ...
                        real, intent(in) :: MM23D(1:nub,1:nub,1:nub,1:nob,1:nob,1:nob),&
