...
def update_t1a(cc_t,ints,sys,shift):
    ...
    t1a = f90_updates.cc_loops.update_t1a(t1a,X1A,fA['oo'],fA['vv'],shift)
...
def update_t1b(cc_t,ints,sys,shift):
    ...
    t1b = f90_updates.cc_loops.update_t1b(t1b,X1B,fB['oo'],fB['vv'],shift)
...
def update_t2a(cc_t,ints,H1A,H1B,H2A,H2B,H2C,sys,shift):
    ...
    t2a = f90_updates.cc_loops.update_t2a(t2a,X2A,fA['oo'],fA['vv'],shift)
...
def update_t2b(cc_t,ints,H1A,H1B,H2A,H2B,H2C,sys,shift):
    ...
    t2b = f90_updates.cc_loops.update_t2b(t2b,X2B,fA['oo'],fA['vv'],fB['oo'],fB['vv'],shift)
...
def update_t2c(cc_t,ints,H1A,H1B,H2A,H2B,H2C,sys,shift):
    ...
    t2c = f90_updates.cc_loops.update_t2c(t2c,X2C,fB['oo'],fB['vv'],shift)
...
def update_t3a(cc_t,ints,H1A,H1B,H2A,H2B,H2C,sys,shift):
    ...
    t3a = f90_updates.cc_loops.update_t3a(t3a,X3A,fA['oo'],fA['vv'],shift)
...
def update_t3b(cc_t,ints,H1A,H1B,H2A,H2B,H2C,sys,shift):
    ...
    t3b = f90_updates.cc_loops.update_t3b(t3b,X3B,fA['oo'],fA['vv'],fB['oo'],fB['vv'],shift)
...
def update_t3c(cc_t,ints,H1A,H1B,H2A,H2B,H2C,sys,shift):
    ...
    t3c = f90_updates.cc_loops.update_t3c(t3c,X3C,fA['oo'],fA['vv'],fB['oo'],fB['vv'],shift)
...
def update_t3d(cc_t,ints,H1A,H1B,H2A,H2B,H2C,sys,shift):
    ...
    t3d = f90_updates.cc_loops.update_t3d(t3d,X3D,fB['oo'],fB['vv'],shift)
