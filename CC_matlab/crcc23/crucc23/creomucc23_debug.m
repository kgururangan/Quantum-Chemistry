function [omega_crcc23A,omega_crcc23B,omega_crcc23C,omega_crcc23D] = creomucc23_debug(L3A,L3B,L3C,L3D,D3A,D3B,D3C,D3D,M3A,M3B,M3C,M3D,...
                                                                                    cc_t,omega,HBar_t,sys,iroot)

    fprintf('\n==================================++Entering CR-EOMUCC(2,3) Routine++=============================\n')
                ...
                for i = 1:Nocc_a
                    for j = i+1:Nocc_a
                        for k = j+1:Nocc_a
                            ...
                            temp = L3A(i,j,k,a,b,c)*(M3A(a,b,c,i,j,k) + r0*MM23A(a,b,c,i,j,k));
                            ...
                            deltaD = deltaD + temp/D3A(a,b,c,i,j,k);
                            ct = ct + 1;
                        end
                    end
                end
                ...
                for i = 1:Nocc_a
                    for j = i+1:Nocc_a
                        for k = 1:Nocc_b
                            ...
                            temp = L3B(i,j,k,a,b,c)*(M3B(a,b,c,i,j,k) + r0*MM23B(a,b,c,i,j,k));
                            ...
                            deltaB = deltaB + temp/D_B;
                            deltaC = deltaC + temp/D_C;
                            deltaD = deltaD + temp/D3B(a,b,c,i,j,k);
                            ct = ct + 1;
                        end
                    end
                end
                ...
                for i = 1:Nocc_a
                    for j = 1:Nocc_b
                        for k = j+1:Nocc_b
                            ...
                            temp = L3C(i,j,k,a,b,c)*(M3C(a,b,c,i,j,k) + r0*MM23C(a,b,c,i,j,k));
...
%                                 fprintf('M3C = %4.12f\n',M3C(a,b,c,i,j,k) + r0*MM23C(a,b,c,i,j,k))
%                                 fprintf('L3C = %4.12f\n',L3C(i,j,k,a,b,c))
%                                 fprintf('D_A = %4.12f\n',D_A)
%                                 fprintf('D_B = %4.12f\n',D_B)
%                                 fprintf('D_C = %4.12f\n',D_C)
...
%                             end
                            ...
                            deltaB = deltaB + temp/D_B;
                            deltaC = deltaC + temp/D_C;
                            deltaD = deltaD + temp/D3C(a,b,c,i,j,k);
                            ct = ct + 1;
                        end
                    end
                end
                ...
                for i = 1:Nocc_b
                    for j = i+1:Nocc_b
                        for k = j+1:Nocc_b
                            ...
                            temp = L3D(i,j,k,a,b,c)*(M3D(a,b,c,i,j,k) + r0*MM23D(a,b,c,i,j,k));
                            ...
                            deltaB = deltaB + temp/D_B;
                            deltaC = deltaC + temp/D_C;
                            deltaD = deltaD + temp/D3D(a,b,c,i,j,k);
                            ct = ct + 1;
                        end
                    end
                end
...
%     omega_crcc23A = deltaA; 
%     omega_crcc23B = deltaB;
%     omega_crcc23C = deltaC;
%     omega_crcc23D = deltaD;
