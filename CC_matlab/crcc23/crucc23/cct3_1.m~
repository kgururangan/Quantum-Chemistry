                ...
                for i = 1:Nocc_a
                    for j = i+1:Nocc_a
                        for k = j+1:Nocc_a
                            ...
                            if is_P([i,j,k],act_h_alpha_range) && is_P([a,b,c],act_p_alpha_range)
                ...
                for i = 1:Nocc_a
                    for j = i+1:Nocc_a
                        for k = 1:Nocc_b
                            ...
                            if (is_P([i,j],act_h_alpha_range) || is_P(k,act_h_beta_range)) && ...
                                    (is_P([a,b,c],act_p_alpha_range) || is_P(c,act_p_beta_range))
                ...
                for i = 1:Nocc_a
                    for j = 1:Nocc_b
                        for k = j+1:Nocc_b
                            ...
                            if (is_P(i,act_h_alpha_range) || is_P([j,k],act_h_beta_range)) && ...
                                    (is_P(a,act_p_alpha_range) || is_P([b,c],act_p_beta_range))
                ...
                for i = 1:Nocc_b
                    for j = i+1:Nocc_b
                        for k = j+1:Nocc_b
                            ...
                            if is_P([i,j,k],act_h_beta_range) && is_P([a,b,c],act_p_beta_range)
