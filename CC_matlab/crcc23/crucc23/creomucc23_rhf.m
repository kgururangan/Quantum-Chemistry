function [deltaA,deltaB,deltaC,deltaD] = creomucc23_rhf(cc_t,omega,HBar_t,sys,iroot)

    fprintf('RHF EOMCC(2,3) MOMENT CORRECTION\n')
...
%                             end
                            ...
                            deltaA = deltaA + 2*temp/D_A;
                            deltaB = deltaB + 2*temp/D_B;
                            deltaC = deltaC + 2*temp/D_C;
                            deltaD = deltaD + 2*temp/D_D;
