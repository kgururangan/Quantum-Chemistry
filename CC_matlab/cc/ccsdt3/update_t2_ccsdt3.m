function [t2] = update_t2_ccsdt3(t1,t2,t3,sys)
    ...
    I9 = I9(sys.iact_h,sys.iact_h,sys.iact_h,sys.iact_p);
    
    I10 = sys.Vvovv - einsum_kg(sys.Voovv,t1,'mnef,am->anef');
    I10 = I10(sys.iact_p,sys.iact_h,sys.iact_p,sys.iact_p);
    ...
    TEMP2_3 =  einsum_kg(chi_me(sys.iact_h,sys.iact_p),t3,'me,abeijm->abij') ...
        ...
        for b = a+1:sys.Nunocc
            for i = 1:sys.Nocc
                for j = i+1:sys.Nocc
                    ...
                    if b <= sys.Nact_p && i- sys.Ncore > 0
                        t2(a,b,i,j) = (X_abij(a,b,i,j)+TEMP2_3(a,b,i-sys.Ncore,j-sys.Ncore))/...
