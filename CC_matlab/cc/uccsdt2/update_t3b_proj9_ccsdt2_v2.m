function [t3b] = update_t3b_proj9_ccsdt2_v2(t1a,t1b,t2a,t2b,t2c,T3A,T3B,T3C,T3D,HBar_t,sys,shift)
    ...
    D7 = +einsum_kg(H2A.voov(pA,HA,HA,pA),T3B.PpPHHh,'bMJe,AeCIMk->AbCIJk')...
