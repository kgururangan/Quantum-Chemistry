function [X2A] = update_t2a_proj9(t1a,t1b,t2a,t2b,t2c,T3A,T3B,T3C,T3D,sys,shift)
...
-einsum_kg(H2A.ooov(HA,hA,hA,PA),T3A.PpphhH,'MniF,FabjnM->abij')...
+0.5*einsum_kg(H2A.ooov(HA,HA,hA,pA),T3A.ppphHH,'MNif,abfjMN->abij')...
+0.5*einsum_kg(H2A.ooov(HA,HA,hA,PA),T3A.PpphHH,'MNiF,FabjMN->abij');
