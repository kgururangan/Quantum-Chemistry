function [X2A] = update_t2a_proj3(t1a,t1b,t2a,t2b,t2c,T3A,T3B,T3C,T3D,sys,shift)
...
-einsum_kg(H1A.ov(hA,PA),T3A.PPPhhH,'mE,ABEimJ->ABiJ')...
...
+0.5*einsum_kg(H2A.ooov(hA,hA,hA,PA),T3A.PPPhhH,'mniF,ABFmnJ->ABiJ')...
...
D5 = +0.5*einsum_kg(H2A.vovv(PA,hA,pA,pA),T3A.PpphhH,'Anef,BefinJ->ABiJ')...
-einsum_kg(H2A.vovv(PA,hA,PA,pA),T3A.PPphhH,'AnEf,EBfinJ->ABiJ')...
-0.5*einsum_kg(H2A.vovv(PA,hA,PA,PA),T3A.PPPhhH,'AnEF,EBFinJ->ABiJ')...
