function [t3d] = update_t3d_proj3_ccsdt2_v2(t1a, t1b, t2a, t2b, t2c, T3A, T3B, T3C, T3D, HBar_t, sys, shift)
    ...
    D5 = -0.5*einsum_kg(H2C.oooo(HB,HB,HB,HB),T3D.PPPhHH,'MNKJ,ABCiMN->ABCiJK');

    D6 = -einsum_kg(H2C.vvvv(PB,PB,PB,pB),T3D.PPphHH,'ABEf,ECfiJK->ABCiJK')...
    ...
    D10 = +einsum_kg(H2C.voov(PB,HB,HB,pB),T3D.PPphHH,'AMJe,BCeiMK->ABCiJK')...
