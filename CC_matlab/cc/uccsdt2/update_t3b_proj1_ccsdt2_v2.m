function [t3b] = update_t3b_proj1_ccsdt2_v2(t1a, t1b, t2a, t2b, t2c, T3A, T3B, T3C, T3D, HBar_t, sys, shift)
...
-einsum_kg(H2B.ovov(HA,PB,HA,PB),T3B.PPPHHH,'MCIE,ABEMJK->ABCIJK');
    ...
    X3B_PPPHHH =  D2 + D4 + D5 + D7 + D11 + D12 + D_3_8_13 + D_1_6_14 + D_9_10 + MM23B;
