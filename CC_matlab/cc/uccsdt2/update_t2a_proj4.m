function [X2A] = update_t2a_proj4(t1a,t1b,t2a,t2b,t2c,T3A,T3B,T3C,T3D,sys,shift)
...
+einsum_kg(H1A.ov(hA,PA),T3A.PPphhH,'mE,AEbimJ->AbiJ')...
...
-0.5*einsum_kg(H2A.ooov(hA,hA,HA,PA),T3A.PPphhh,'mnJF,AFbmin->AbiJ')...
+einsum_kg(H2A.ooov(HA,hA,HA,pA),T3A.PpphhH,'MnJf,AbfinM->AbiJ')...
-einsum_kg(H2A.ooov(HA,hA,HA,PA),T3A.PPphhH,'MnJF,AFbinM->AbiJ')...
-0.5*einsum_kg(H2A.ooov(HA,HA,HA,pA),T3A.PpphHH,'MNJf,AbfiMN->AbiJ')...
+0.5*einsum_kg(H2A.ooov(HA,HA,HA,PA),T3A.PPphHH,'MNJF,AFbiMN->AbiJ');
...
-0.5*einsum_kg(H2A.vovv(pA,hA,pA,pA),T3A.PpphhH,'bnef,AefinJ->AbiJ')...
+einsum_kg(H2A.vovv(pA,hA,PA,pA),T3A.PPphhH,'bnEf,EAfinJ->AbiJ')...
+0.5*einsum_kg(H2A.vovv(pA,hA,PA,PA),T3A.PPPhhH,'bnEF,EAFinJ->AbiJ')...
