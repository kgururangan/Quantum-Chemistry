function [t2a] = update_t2a_jun(t1a,t1b,t2a,t2b,t2c,sys,shift)
 ...
 new_t = +einsum_permute('abij->abij', sys.vA_vvoo);
    new_t = new_t -einsum_permute('ijba->abij', z1);
    new_t = new_t +einsum_permute('ijab->abij', z1);
    new_t = new_t +einsum_permute('iabj->abij', z2);
    new_t = new_t -einsum_permute('jabi->abij', z2);
    new_t = new_t +einsum_permute('ijab->abij', z3);
    new_t = new_t -einsum_permute('jiab->abij', z3);
    new_t = new_t +einsum_permute('bija->abij', z4);
    new_t = new_t -einsum_permute('aijb->abij', z4);
    new_t = new_t +0.5*einsum_permute('ijab->abij', z5);
    new_t = new_t +einsum_permute('ibja->abij', z6);
    new_t = new_t -einsum_permute('iajb->abij', z6);
    new_t = new_t -einsum_permute('jbia->abij', z6);
    new_t = new_t +einsum_permute('jaib->abij', z6);
    new_t = new_t +0.5*einsum_permute('abij->abij', z7);
    new_t = new_t -einsum_permute('ibja->abij', z8);
    new_t = new_t +einsum_permute('iajb->abij', z8);
    new_t = new_t +einsum_permute('jbia->abij', z8);
    new_t = new_t -einsum_permute('jaib->abij', z8);
    new_t = new_t +einsum_permute('ijab->abij', z10);
    new_t = new_t -einsum_permute('ijba->abij', z12);
    new_t = new_t +einsum_permute('ijab->abij', z12);
    new_t = new_t +einsum_permute('jiba->abij', z12);
    new_t = new_t -einsum_permute('jiab->abij', z12);
    new_t = new_t +einsum_permute('iabj->abij', z14);
    new_t = new_t +0.5*einsum_permute('ijab->abij', z18);
    new_t = new_t -0.5*einsum_permute('jiab->abij', z18);
    new_t = new_t -einsum_permute('jaib->abij', z38);
    new_t = new_t +einsum_permute('iajb->abij', z38);
    new_t = new_t -einsum_permute('jaib->abij', z44);
    new_t = new_t +einsum_permute('iajb->abij', z44);
    new_t = new_t +einsum_permute('ijab->abij', z46);
    new_t = new_t -einsum_permute('jiab->abij', z46);
