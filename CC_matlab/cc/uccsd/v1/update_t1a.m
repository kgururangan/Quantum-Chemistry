function [t1a] = update_t1a(t1a, t1b, t2a, t2b, t2c, chi1A, chi1B, chi2A, chi2B, chi2C, sys)
    ...
    X1a_ia = sys.fa_vo +... % 1
             +einsum_kg(chi1A.ae_bar,t1a,'ae,ei->ai')... % 2
             -einsum_kg(einsum_kg(chi1A.me,t1a,'me,am->ae'),t1a,'ae,ei->ai')... % 3
             -einsum_kg(chi1A.mi_bar,t1a,'mi,am->ai')... % 2
...
%       X1a_ia = sys.fa_vo +...
%              +einsum_kg(chi1A.ae,t1a,'ae,ei->ai')... 
%              -einsum_kg(chi1A.mi,t1a,'mi,am->ai')... 
%              +0.5*einsum_kg(sys.vA_vovv,t2a,'amef,efim->ai')...
%              -0.5*einsum_kg(sys.vA_ooov,t2a,'mnie,aemn->ai')...
%              +einsum_kg(sys.vB_vovv,t2b,'amef,efim->ai')...
%              -einsum_kg(sys.vB_ooov,t2b,'mnie,aemn->ai')...
%              +einsum_kg(sys.vA_voov,t1a,'amie,em->ai')...
%              +einsum_kg(sys.vB_voov,t1b,'amie,em->ai');
