function [t2a] = update_t2a(t1a, t1b, t2a, t2b, t2c, sys, shift)
    ...
    % <ijab|H(CCS)|0> intermediates 
    % note: need weights of 0.5 to compensate diagrams that do not have A(ij) or A(ab)
    ...
    % weight of 0.5 on (V T2B^2) term to correct for A(ij)A(ab) contraction term
