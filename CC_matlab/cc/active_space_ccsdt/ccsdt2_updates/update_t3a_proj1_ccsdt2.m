function [X3A_PPPHHH] = update_t3a_proj1_ccsdt2(t1a, t1b, t2a, t2b, t2c, T3A, T3B, T3C, T3D, sys, shift)
...
D3 =-einsum_kg(H2A.oooo(HA,hA,HA,HA),T3A.PPPhHH,'MnIJ,ABCnMK->ABCIJK')...
