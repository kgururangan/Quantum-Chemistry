function [X3A_PPpHHH] = update_t3a_proj2_ccsdt2(t1a,t1b,t2a,t2b,t2c,T3A,T3B,T3C,T3D,sys,shift)
...
D3 =+einsum_kg(H1A.vv(PA,PA),T3A.PPpHHH,'BE,AEcIJK->ABcIJK');
...
D6 =+einsum_kg(H2A.vvvv(PA,pA,PA,pA),T3A.PPpHHH,'AcEf,EBfIJK->ABcIJK')...
...
D8 =+einsum_kg(H2A.voov(PA,hA,HA,PA),T3A.PPphHH,'BmKE,AEcmIJ->ABcIJK')...
