function [X2A] = update_t2a_proj1(t1a,t1b,t2a,t2b,t2c,T3A,T3B,T3C,T3D,sys,shift)
...
+einsum_kg(H1A.ov(hA,PA),T3A.PPPhHH,'mE,ABEmIJ->ABIJ')...
...
D5 = -0.5*einsum_kg(H2A.vovv(PA,hA,pA,pA),T3A.PpphHH,'Anef,BefnIJ->ABIJ')...
+einsum_kg(H2A.vovv(PA,hA,PA,pA),T3A.PPphHH,'AnEf,EBfnIJ->ABIJ')...
+0.5*einsum_kg(H2A.vovv(PA,hA,PA,PA),T3A.PPPhHH,'AnEF,EBFnIJ->ABIJ')...
