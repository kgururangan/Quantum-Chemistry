function [t2a] = update_t2a_ccsdt_jun(t1a,t1b,t2a,t2b,t2c,t3a,t3b,t3c,t3d,HBar_t,sys,shift)
        ...
        for b = a+1:sys.Nvir_alpha
            for i = 1:sys.Nocc_alpha
                for j = i+1:sys.Nocc_alpha
                    ...
                    coef_1 = X2A_abij(a,b,i,j) / denom;
                    coef_2 = CCSDT(a,b,i,j) / denom;
                    
                    t2a(a,b,i,j) = t2a(a,b,i,j) + coef_1 + coef_2;              
