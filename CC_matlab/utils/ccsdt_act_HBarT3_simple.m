                                ...
                                ctr2 = CTR2(q);
                                    for r = 1:length(CTR3)
                                        ...
                                        for s = 1:length(CTR4)
                                            ...
                                            val1 = get_character(ctr1); val2 = get_character(ctr2); 
                                            val3 = get_character(ctr3); val4 = get_character(ctr4);
                                            X1 = [val1, ss1]; X2 = [val2, ss2]; X3 = [val3,ss3]; X4 = [val4,ss4];
                                            coefnum = 1;
                                            if all(X1 == X2) 
                                                coefnum = coefnum * 0.5;
                                            ...
                                            coef = num2str(coefnum);

                                            arr1 = C1; 
                                            arr1{idx1(1)} = ctr1; arr1{idx1(2)} = ctr2; 
                                            arr1{idx1(3)} = ctr3; arr1{idx1(4)} = ctr4;
                                            arr2 = C2; 
                                            arr2{idx2(1)} = ctr1; arr2{idx2(2)} = ctr2; 
                                            arr2{idx2(3)} = ctr3; arr2{idx2(4)} = ctr4;
                                            [new_arr,sign2] = fix_t3_indices(cell2mat(arr2),q2(end));
                                            if isempty(sign2) || sign2 == '+'
                                                sign = sign_orig;
                                            else
