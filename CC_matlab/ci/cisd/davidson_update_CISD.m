function [ R, eigval, resid_norm, flag_conv] = davidson_update_CISD(Ax, Dai, Dabij, nroot, B0, opts)
...
%                 for j = i+1:Nocc
%                     tmp = r2(a,b,i,j);
%                     r2(a,b,i,j) = tmp/(e-D2(a,b,i,j));
%                     r2(a,b,j,i) = -tmp/(e-D2(a,b,j,i)); 
%                     r2(b,a,i,j) = -tmp/(e-D2(b,a,i,j));
%                     r2(b,a,j,i) = tmp/(e-D2(b,a,j,i));
%                 end
%             end
%         end
%     end
